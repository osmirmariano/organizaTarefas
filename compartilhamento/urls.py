...
urlpatterns = [
    ...
    url(r'^compartilhamentos$', views.CompartilharTarefas.as_view(), name='compartilhar-tarefas'),
    url(r'^compartilhar$', views.CompartilharTarefasUsuario.as_view(), name='compartilhar-usuario'),
